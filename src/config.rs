...
pub struct Config {
    ...
    pub db_insert_batch_size_rows: usize,

    /// The maximum total size of tasks that are buffered
    /// before being written to InflightTaskStore (sqlite).
    pub db_insert_batch_size_bytes: usize,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            db_insert_batch_size_rows: 256,
            db_insert_batch_size_bytes: 400_000,
